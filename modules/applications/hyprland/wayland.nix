...
in {
  home-manager.users.kgoe = _: {
    ...
    #
    #        exec-once = swww-daemon & swww img ~/projects/nixos-config/assets/images/wallpaper_abstract_nord4x.png & mako & lxqt-policykit-agent & dbus-update-activation-environment --systemd WAYLAND_DISPLAY XDG_CURRENT_DESKTOP
    #
